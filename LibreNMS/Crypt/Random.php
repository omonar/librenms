...
class Random
{
    ...
    static function string($length)
    {
        ...
        if ($crypto === false) {
            ...
            switch (true) {
                case class_exists('\LibreNMS\Crypt\AES'):
                    $crypto = new AES(Base::MODE_CTR);
                    break;
                case class_exists('\LibreNMS\Crypt\Twofish'):
                    $crypto = new Twofish(Base::MODE_CTR);
                    break;
                case class_exists('\LibreNMS\Crypt\Blowfish'):
                    $crypto = new Blowfish(Base::MODE_CTR);
                    break;
                case class_exists('\LibreNMS\Crypt\TripleDES'):
                    $crypto = new TripleDES(Base::MODE_CTR);
                    break;
                case class_exists('\LibreNMS\Crypt\DES'):
                    $crypto = new DES(Base::MODE_CTR);
                    break;
                case class_exists('\LibreNMS\Crypt\RC4'):
                    $crypto = new RC4();
                    break;
                default:
